 ...
 */
export function filteredMedia(prevResults, queryParams) {
...
function applyMediaTypeFilter(results, mediaType) {
    if (!mediaType)
        return results;
...
function applyScoreFilter(results, score, scoreG, scoreL) {
...
function applyDateRangeFilter(results, from, to) {
    if (!from || !to)
        return results;
